...
class UNIVERSAL(CommonConfig):
    ...
    BALANCE_CONTROL_ID_GROUP = {
        "total_asset": 1015, # 总资产
        "market_value": 1014, # 持仓市值
        "frozen_balance": 1013, # 冻结金额
        "fund_balance": 1012, # 资金余额 
        "available_balance": 1016, # 可用金额
        "withdrawable_cash": 1017, # 可取金额
        "total_pl_amount": 1027,   # 总盈亏
        "daily_pl_amount": 1026,   # 当日盈亏
        # "total_pl_ratio": 1030,   # 总盈亏比
        # "daily_pl_ratio": 1029,   # 当日盈亏比
    }
