        ...
        try:
            ...
            for p in positions:
                ...
                if stock_code == stock_code_new:
                    ...
                    cost_price = p.get('成本价') or p.get('cost_price') or 0.0
                    current_price = p.get('市价') or p.get('current_price') or 0.0
                    market_value = p.get('市值') or p.get('market_value') or 0.0
                    total_pl_amount = p.get('盈亏') or p.get('total_pl_amount') or 0.0
                    total_pl_ratio = p.get('盈亏比(%)') or p.get('total_pl_ratio') or 0.0
